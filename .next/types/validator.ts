...
// Validate ../../src/app/api/wallet/balances/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/wallet/balances">> = Specific
  const handler = {} as typeof import("../../src/app/api/wallet/balances/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/wallet/transaction/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/wallet/transaction">> = Specific
  const handler = {} as typeof import("../../src/app/api/wallet/transaction/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
